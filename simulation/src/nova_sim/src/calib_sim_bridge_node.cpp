...
public:
  ...
  : Node("calib_sim_bridge_node", options), feedback_delay_ms_(800)
  {
    ...
    target_sub_ = this->create_subscription<calib_sim::msg::ArmPose>(
    ...
    calib_pose_pub_ = this->create_publisher<calib_sim::msg::ArmPose>(calib_pose_feedback_topic_, 20);
...
private:
  void onCalibTarget(const calib_sim::msg::ArmPose::SharedPtr msg)
  {
  ...
  void publishInitialPose()
  {
    ...
    calib_sim::msg::ArmPose init_msg;
  ...
  bool tryUpdatePoseFromTf(int arm_id)
  {
    ...
    calib_sim::msg::ArmPose pose_msg;
...
private:
  ...
  {
    calib_sim::msg::ArmPose target_pose;
  ...
  calib_sim::msg::ArmPose current_pose_;
  std::shared_ptr<tf2_ros::Buffer> tf_buffer_;
  std::shared_ptr<tf2_ros::TransformListener> tf_listener_;

  rclcpp::Subscription<calib_sim::msg::ArmPose>::SharedPtr target_sub_;
  ...
  rclcpp::Publisher<calib_sim::msg::ArmPose>::SharedPtr calib_pose_pub_;
...
int main(int argc, char ** argv)
{
  ...
  const auto pkg_share = ament_index_cpp::get_package_share_directory("nova_sim");
