...
// 默认加载 share/calib_sim_isaac/config/calib_unified.yaml。
int main(int argc, char ** argv)
{
  ...
  auto ui_node = std::make_shared<calib_sim_isaac::CalibQtUiRosNode>(rclcpp::NodeOptions{});
  ...
  const int rc = calib_sim_isaac::RunCalibQtUiApp(ui_node, argc, argv);
  (void)rc;
  exec.cancel();
