...
#include "ros_robot_workbench/module/intrinsic_calibration_module.h"
...
: QWidget(parent)
{
  ...
  auto image_node = rclcpp::Node::make_shared("ros_robot_workbench_intrinsic_preview_" + std::to_string(stamp));
