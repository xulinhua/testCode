#ifndef ROS_ROBOT_WORKBENCH__UI__ZOOMABLE_IMAGE_WIDGET_H_
#define ROS_ROBOT_WORKBENCH__UI__ZOOMABLE_IMAGE_WIDGET_H_
...
#endif  // ROS_ROBOT_WORKBENCH__UI__ZOOMABLE_IMAGE_WIDGET_H_
