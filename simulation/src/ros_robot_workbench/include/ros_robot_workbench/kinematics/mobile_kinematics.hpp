#ifndef ROS_ROBOT_WORKBENCH__KINEMATICS__MOBILE_KINEMATICS_HPP_
#define ROS_ROBOT_WORKBENCH__KINEMATICS__MOBILE_KINEMATICS_HPP_
...
#endif  // ROS_ROBOT_WORKBENCH__KINEMATICS__MOBILE_KINEMATICS_HPP_
