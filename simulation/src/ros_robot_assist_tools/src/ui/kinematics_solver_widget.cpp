...
QString KinematicsAssetPath(const QString & name)
{
  ...
  return base + "/../../share/ros_robot_assist_tools/assets/kinematics/" + name;
}
...
, kdl_cache_()
{
  ...
  QObject::connect(backend_, qOverload<int>(&QComboBox::currentIndexChanged), [sync_moveit_fields](int) { sync_moveit_fields(); });
