...
class TopicConfig:
    ...
    pub_imu: str = TOPIC_IMU
    pub_lidar_points: str = TOPIC_LIDAR_POINTS
    pub_lidar_scan: str = TOPIC_LIDAR_SCAN

    frame_odom: str = FRAME_ODOM
    frame_base: str = FRAME_BASE
    frame_camera: str = FRAME_CAMERA
    frame_imu: str = FRAME_IMU
    frame_lidar: str = FRAME_LIDAR
    ...
    enable_lidar_points: bool = True
    enable_lidar_scan: bool = False
...
TOPIC_FIELD_SPECS = (
    ...
    ("pub_imu", "imu"),
    ("pub_lidar_points", "lidar points"),
    ("pub_lidar_scan", "lidar scan"),
    ("frame_odom", "frame odom"),
    ("frame_base", "frame base"),
    ("frame_camera", "depth optical frame"),
    ("frame_imu", "frame imu"),
    ("frame_lidar", "frame lidar"),
)
...
STREAM_TOGGLE_SPECS = (
    ...
    ("enable_imu", "imu"),
    ("enable_lidar_points", "lidar points"),
    ("enable_lidar_scan", "lidar scan"),
    ("enable_odom", "odom"),
    ("enable_tf", "tf"),
