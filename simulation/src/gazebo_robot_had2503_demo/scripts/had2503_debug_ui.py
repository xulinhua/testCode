...
class ChassisPanel(QWidget):
    def __init__(self, parent: Optional[QWidget] = None) -> None:
        ...
        self.vx.setRange(-1.5, 1.5)
        self.vx.setSingleStep(0.05)
        self.vx.setDecimals(3)
        self.vx.setSuffix(" m/s")
        self.wz = QDoubleSpinBox()
        self.wz.setRange(-2.0, 2.0)
        self.wz.setSingleStep(0.05)
        ...
        self.btn_fwd = QPushButton("前进 0.2")
        self.btn_back = QPushButton("后退 0.2")
        ...
        self.btn_fwd.clicked.connect(lambda: self._preset(0.2, 0.0))
        self.btn_back.clicked.connect(lambda: self._preset(-0.2, 0.0))
        self.btn_left.clicked.connect(lambda: self._preset(0.0, 0.4))
        self.btn_right.clicked.connect(lambda: self._preset(0.0, -0.4))
