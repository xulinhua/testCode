...
def generate_launch_description():
    ...
    cam_id_arg = DeclareLaunchArgument(
        'camera_id',
        default_value='',
        description='Camera ID to use for OBB detection'
    )
    ...
    # 创建节点的函数
    def create_obb_det_node(context):
        ...
        node_name = f'obb_det_node_{camera_id}'
    ...
    obb_det_node_creator = OpaqueFunction(function=create_obb_det_node)
    ...
    ld.add_action(obb_det_node_creator)
    return ld
