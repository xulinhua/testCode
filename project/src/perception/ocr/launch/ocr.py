...
def generate_launch_description():
    ...
    camera_id_arg = DeclareLaunchArgument(
        'camera_id',
        default_value='',
        description='Camera ID to use for OCR detection'
    )
    ...
    def create_ocr_node(context):
        ...
        node_name = f'ocr_node_{camera_id}'
    ...
    ocr_node_creator = OpaqueFunction(function=create_ocr_node)
    ...
    ld.add_action(ocr_node_creator)
    return ld
