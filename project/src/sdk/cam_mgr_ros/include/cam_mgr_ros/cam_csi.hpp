#ifndef CAM_MGR_ROS__CAM_CSI_HPP_
#define CAM_MGR_ROS__CAM_CSI_HPP_
...
public:
    ...
    /**
     * @brief 获取 CSI相机 的 ROI 和 FPS 列表（静态函数）
     * @param cam_id 相机 ID
    ...
    static bool get_roi_fps_list_tegra(int cam_id, std::map<std::string, CamMgr::CamRoiFpsList>& sensor_roi_fps_map);
    ...
    /**
     * @brief 枚举 CSI相机 设备（静态函数）
     * @param cam_dev_list CSI相机设备信息列表输出参数
     * @return 是否枚举成功
     */
...
#endif  // CAM_MGR_ROS__CAM_CSI_HPP_