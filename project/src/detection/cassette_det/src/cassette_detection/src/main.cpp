...
int main(int argc, char** argv) 
{
    ...
    try 
    {
        ...
        std::string engine_path = "/home/hs/zlx/Yolo_Det/src/Yolo_Detection/models/coco_v11s.engine";
        std::string image_path = "/home/hs/zlx/Yolo_Det/src/Yolo_Detection/test_switch_button_imgs/c66a5c25110e3739f72d5241656557fd_compress.jpg";
