...
def main():
    ...
    # 为这个测试程序创建独立的Aruco检测器实例
    print("创建独立的Aruco检测器实例用于测试")
    ...
    try:
        ...
        while True:
            ...
            print("调用aruco_detector.detect_and_process_markers...")
            ...
            print(f"返回结果: found={result['found']}, markers_info长度={len(markers_info)}")
