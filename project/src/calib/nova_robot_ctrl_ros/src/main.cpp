...
int main(int argc, char * argv[])
{
  std::vector<std::string> new_argv_strings;
    ...
    std::string default_config_file_path = ament_index_cpp::get_package_share_directory("nova_robot_ctrl_ros") + "/config" + "/nova_robot_ctrl_ros.yaml";
